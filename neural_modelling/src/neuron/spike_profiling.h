...
static inline void spike_profiling_cache_and_flush_spike_holder(struct spike_holder_t* counter_spikes,
...
static inline int32_t spike_profiling_get_spike_holder_as_int(struct spike_holder_t spikes) {
...
static inline accum spike_profiling_get_spike_holder_as_accum(struct spike_holder_t spikes) {
	union {
		accum acc;
		struct spike_holder_t sh;
	} x;
...
static inline void spike_profiling_print_spikes_from_spike_holder(struct spike_holder_t spikes_orig) {
