#ifndef _NEURON_IMPL_READOUT_H_
#define _NEURON_IMPL_READOUT_H_

#include "neuron_impl.h"

// Includes for model parts used in this implementation
#include <neuron/synapse_types/synapse_types_exponential_impl.h>
#include <neuron/models/neuron_model_lif_readout_impl.h>
...
static bool neuron_impl_do_timestep_update(index_t neuron_index,
	...
	target_ind = timer & 0x3ff; // repeats on a cycle of 1024 entries in array
	timer++; // advance timer - note this prevents use of multiple readouts
    ...
    recorded_variable_values[GSYN_EXCITATORY_RECORDING_INDEX] =
    		global_parameters->target[target_ind]; // record target
    recorded_variable_values[GSYN_INHIBITORY_RECORDING_INDEX] =
    		(global_parameters->target[target_ind] - result); // record error


    // NO LONGER CHECK FOR THRESHOLD, AS WE DON'T WANT READOUT TO FIRE
    ...
    // RETURN FALSE, AS WE DON'T WANT READOUT TO FIRE
