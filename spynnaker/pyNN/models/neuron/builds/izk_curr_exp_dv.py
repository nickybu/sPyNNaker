...
class IzkCurrExpDvDt(AbstractPopulationVertex):
    ...
    def set_model_max_atoms_per_core(new_value=DEFAULT_MAX_ATOMS_PER_CORE):
        IzkCurrExpDvDt._model_based_max_atoms_per_core = new_value

    @staticmethod
    def get_max_atoms_per_core():
        return IzkCurrExpDvDt._model_based_max_atoms_per_core
